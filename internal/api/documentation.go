...
### Workflow
- Call doit_ready to find available work
...
- Call doit_create_issue for new work items
- Call doit_add_dependency to track blockers</code></pre>

<h2>Available Tools (23)</h2>

<h3>Issue CRUD</h3>
<table>
  <tr><th>Tool</th><th>Description</th></tr>
  <tr><td><code>doit_create_issue</code></td><td>Create a new work item (task, bug, feature, epic, etc). Returns the created issue with its hash-based ID. Use --parent to create a hierarchical child (e.g. epic.1).</td></tr>
  ...
  <tr><td><code>doit_list_issues</code></td><td>List issues with filtering by status, type, priority, assignee, and labels. Supports sorting by priority, oldest, updated, or hybrid.</td></tr>
...
<table>
  <tr><th>Tool</th><th>Description</th></tr>
  <tr><td><code>doit_ready</code></td><td>List issues ready for work — open, not blocked, not deferred. Call this to find the next task to work on.</td></tr>
</table>
