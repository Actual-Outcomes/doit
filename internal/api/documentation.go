...
<table>
  ...
  <tr><td><code>doit_list_issues</code></td><td>List issues with filtering by status, type, priority, assignee, and labels. <code>status</code> takes a single status (<code>open</code>, <code>in_progress</code>, <code>blocked</code>, <code>deferred</code>, <code>closed</code>, <code>pinned</code>, <code>hooked</code>); omit it or pass <code>all</code> to span every status (use for backlog browse and duplicate/overlap checks). <code>issue_type</code> filters to one type (<code>epic</code>, <code>task</code>, <code>subtask</code>, <code>bug</code>, <code>feature</code>, <code>chore</code>, <code>decision</code>); omit it or pass <code>all</code> (case-insensitive) to span every type. Supports sorting by priority, oldest, updated, or hybrid. Use <code>project</code> (slug) to scope results. Set <code>pinned=true</code> to retrieve only pinned issues. Returns <code>{count, has_more, items}</code> envelope. Defaults: <code>compact=true</code>, <code>limit=50</code>. Without project filter and <code>compact=false</code>, hard cap at 20 items. Oversized responses auto-compact.</td></tr>
